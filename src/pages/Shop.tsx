...
import { ShoppingBag, Plus, Search, Filter, Star } from 'lucide-react';
              ...
              <div key={service.id} className="bg-white rounded-2xl p-6 shadow-sm border border-purple-50 hover:shadow-md transition-all duration-200">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <button className="mt-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-lg font-medium hover:shadow-lg transition-all duration-200">
                      Book Now
                    </button>
                  </div>
                </div>
